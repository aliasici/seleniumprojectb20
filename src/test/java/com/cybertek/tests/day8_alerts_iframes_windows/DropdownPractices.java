...
//        }
        ...
        Assert.assertEquals(BrowserUtils.getElementsText(actualMonthOptions), expectedMonthOptions); // 2
        Assert.assertEquals(actualMonthOptions,expectedMonthOptions,"oldu"); //3
    }
